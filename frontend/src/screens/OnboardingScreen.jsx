...
const IntroSlide = ({ onNext, onSwipeUp }) => {
  ...
  // Mouse drag for browser testing
  ...
  return (
    <div
      style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", animation: "fadeSlideUp 0.5s ease forwards", userSelect: "none" }}
    ...
    >
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", gap: "20px" }}>
        {[
          ...
          "     The way we music is a bit... different. But we think you're gonna love it.",
        ].map((text, i) => (
          <p key={i} style={{
            fontSize: "16px",
            fontWeight: "400",
        ...
        <div style={{ textAlign: "right", marginTop: "8px" }}>
          <span style={{ fontSize: "14px", color: colors.muted, fontFamily: "'Kanit', sans-serif", fontStyle: "italic" }}>
            Swipe to learn more!
          </span>
        </div>
      </div>
...
const ArtistSlide = ({ artist, onSwipeUp, setAppScreen }) => {
  ...
  // Generate gradient fallback from artist name
